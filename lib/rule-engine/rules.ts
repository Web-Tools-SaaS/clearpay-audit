...
export const RULES: Rule[] = [
...

  {
    ...
    search_strings: [
      ...
      'referred to a debt',
      'debt recovery',
      'make other borrowing more difficult',
      'more expensive',
      'impact of using',
      'impact of missed',
    ],
...

  {
    ...
    search_strings: [
      ...
      'fca firm reference',
      'firm reference 1021834',
      'firm reference 900950',
      'firm reference 994790',
    ],
    search_mode: 'ANY',
    fix_suggestion:
  ...
  // Source: A&O Shearman PS26/1 analysis (Feb 2026)
    ...
    search_strings: [
      ...
      'only visible to you',
      'external credit reference agency',
      'credit eligibility',
  ...
  {
    id: 'DPC-018',
    category: 'Key Product Information — Amount of Credit',
    severity: 'HIGH',
    requirement:
      'CONC 4.2A and FCA PS26/1 Chapter 2 require that the amount of credit to be provided ' +
      'under the DPC agreement is included in the Key Product Information given before the consumer ' +
      'enters into the agreement. On a product page this means the total purchase price (which equals ' +
      'the total credit amount for an interest-free DPC) must be stated or clearly calculable from the ' +
      'page. A dynamic widget that shows the price satisfies this; a page with no price at all does not. ' +
      '(FCA PS26/1 Chapter 2; CONC 4.2A — KPI: total amount of credit)',
    fca_source:
      'FCA PS26/1 Chapter 2; CONC 4.2A — KPI required element: total amount of credit',
    fca_url:
      'https://www.fca.org.uk/publications/policy-statements/ps26-1-regulation-deferred-payment-credit',
    search_strings: [
      '£',
    ...
    search_mode: 'ANY',
    fix_suggestion:
      'Ensure the total purchase price (which equals the total credit amount for a 0% DPC) is ' +
      'visible on the page near the BNPL option. Most BNPL on-site messaging widgets display this ' +
      'dynamically from the product price — ensure the widget is rendering correctly and the price ' +
      'element is visible on the crawled page.',
    remediation_type: 'THEME_SETTING',
    regulatory_consequence:
      'The total amount of credit is a named required element of Key Product Information under ' +
      'CONC 4.2A and PS26/1 Chapter 2. Without it, the KPI disclosure is formally incomplete. ' +
      'This is unlikely to affect most product pages where the price is visible, but will flag ' +
      'on pages with dynamic-only or JavaScript-rendered prices that Jina cannot read.',
  },
]
