...
export const RULES: Rule[] = [
...

  {
    ...
    regulatory_consequence: 'If no BNPL provider is detected on this page, our engine cannot verify compliance. After 15 July 2026, operating a DPC arrangement through an unlicensed or undetected provider is a criminal offence under FSMA 2000 s.19. The FCA may require the lender to withdraw the BNPL option from all merchant checkpoints until disclosures are in place.',
  },
...

  {
    ...
    remediation_type: 'THEME_SETTING',
    regulatory_consequence: 'The interest rate is a named required element of Key Product Information under PS26/1 Chapter 2. Failure to state 0% explicitly — even though the rate is zero — means the KPI obligation is unmet. The FCA has confirmed this must appear in writing. Non-compliance after 15 July 2026 exposes the lender to supervisory action and can result in the BNPL option being suspended from your checkout.',
  },

  {
    ...
    remediation_type: 'THEME_SETTING',
    regulatory_consequence: 'Consequences of missed payments is a named required element of Key Product Information under FCA PS26/1 Chapter 2. Without this disclosure, consumers cannot make an informed decision about entering the agreement. Under the Consumer Duty (PS22/9 outcome: products and services), the lender is in breach of the requirement to support consumers in making informed decisions. The FCA may direct the lender to withdraw the product from your checkout.',
  },
